In Lab 7, we developed a BigInt library that supports adding positive numbers that can be arbitrarily large. To that end, that BigInt library is still too simple for us to do anything useful with it.
